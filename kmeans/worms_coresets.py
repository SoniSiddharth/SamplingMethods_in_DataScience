# -*- coding: utf-8 -*-
"""DataScience_Worm_clustering.ipynb

Automatically generated by Colaboratory.

Original file is located at
	https://colab.research.google.com/drive/1VZwkRk_Yb0D5ZQMm65UZ9NvOQeHb2We-
"""
...
for pt in dataset:
  wt[tuple(pt)] = 1
# centers =  kmeans_plusplus(dataset = dataset,k = 25)
# print(len(centers))
...
for ssize in coreset_size:
	...
	avg_cost = 0
	for j in range(5):
		cluster_model = KMeans(n_clusters=25, init='k-means++', random_state=0).fit(data2, sample_weight=coreset_wts)
		centers = cluster_model.cluster_centers_
		mod_centers = []
		for j in centers:
			mod_centers.append(tuple(j))
