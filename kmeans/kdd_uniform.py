# -*- coding: utf-8 -*-
"""KDD_uniform_sklearn.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VfbK6O9q_h3766hM8Kk6_DZE0mYYSeeD
"""
...
for ssize in sample_sizes:
    ...
    avg_cost = 0
    for j in range(5):
        cluster_model = KMeans(n_clusters=50, init='k-means++', random_state=0).fit(uniform_data)
        centers = cluster_model.cluster_centers_
        mod_centers = []
        for j in centers:
            mod_centers.append(tuple(j))
